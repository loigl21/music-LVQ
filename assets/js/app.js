  ...
  handlePlaylists: {
    ...
    handleOwnPlaylists: {
      renderOwnPlaylists: function() {
        const ownPlaylists = app.handlePlaylists.playlists.filter(playlist => !playlist.tag.includes('liked songs') && playlist.owner == 'LVQ')
          .map(playlist => `
          ...
          <div id="on-open-playlist__header">
            ...
            <div id="on-open-playlist__header__title">
              ...
              <div id="on-open-playlist__header__title__playlist-info">
                ${thisPlaylistInDB.tag.includes('own playlist') ? '<img id="on-open-playlist__header__title__playlist-info__img" src="./assets/images/user/3lvq.jpg"><span id="on-open-playlist__header__title__playlist-info__owner">' + thisPlaylistInDB.owner : '<span id="on-open-playlist__header__title__playlist-info__owner"><span>Made for</span> LVQ'} <span>• ${thisPlaylistInDB.songs.length} songs</span></span>
                </div>
            </div>
          </div>
