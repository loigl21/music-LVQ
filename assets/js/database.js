const allSongs = [
  ...
  },
  {
    id: 83, 
    name: "Dằm Trong Tim", 
    artist: ["Sunni Hạ Linh cover"],
    img: "./data/singles/damtrongtim.jpg",
    path: "./data/songs/damtrongtim.mp3",
    album: "Dằm Trong Tim",
  ...
  },
  {
    ...
    artist: ["Khang Việt"],
    img: "./data/singles/emnendunglai.jpg",
    path: "./data/songs/emnendunglai.mp3",
    album: "Em Nên Dừng Lại",
  ...
  },
  {
    ...
    name: "Yêu", 
    artist: ["阿肆"],
    img: "./data/singles/yeu.jpg",
    path: "./data/songs/yeu.mp3",
    album: "Yêu",
...
const allUsers = [
  {
    id: 1,
    name: "Đặng Quang Lợi",
    avatarPath: './assets/images/user/dql.jpg',
    latestSongID: '83',
    lastActive: 'online',
  },
  {
    ...
    avatarPath: './assets/images/user/nqv.jpg',
    latestSongID: '84',
    lastActive: '10h',
  },
  {
    ...
    avatarPath: './assets/images/user/nxq.jpg',
    latestSongID: '85',
    lastActive: '1d',
  }
]
